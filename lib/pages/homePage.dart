...
class _homePageState extends State<homePage> {
  ...
  getData() async {
    listTrending = await repository.getData();
    setState(() {});
  }
                ...
                child: Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return resortCard(
                        resortName: listTrending[index].name,
                        image: listTrending[index].image,
                        location: listTrending[index].name_location,
                        ratting: listTrending[index].ratting,
                        price: listTrending[index].price,
                        ontap: () {},
                      );
                    },
